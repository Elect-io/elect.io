...
class SideBar extends React.Component {
    ...
    render() {
        ...
        return (<div className="sidebar">
            <Link to="/profile" className="sidebar-each"><AccountCircle onClick={() => this.setState({ selected: 1 })} active={this.state.selected === 1} /><SideBarToolkit options={[{ link: "/profile/login", title: "Login" }, { link: "/profile/sign-up", title: "Sign Up" }]} /></Link>
