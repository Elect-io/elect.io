    ...
    return (<div className="profile">
        ...
        <div className="profile-body">
            ...
            <div>
                ...
                <h3 className="profile-map-title">You agree with {profile.name} on {Math.round((profile.analyze?.matchingQuestions/profile.analyze?.totalQuestions)*10000)/100}% of Issues</h3>
            </div>
        </div>
