...
<h3>Hey, ${name}</h3>
<p>A reset password request was created for your account on elect.io; to verify that this action was performed by you, click on the "Reset Password" button below. If you didn't perform this action, click on the "Close reset request" button below. </p>
